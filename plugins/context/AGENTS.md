...
| ----- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| skill | context:generate-docs-index       | Auto-generate docs/index.md from docs/ directory contents. Use when adding, removing, or reorganizing documentation files, or when asked to generate a docs index.                                                                                                                                                                                                                                    |
...
| skill | context:refactor-project-context  | Use when scanning and reorganizing all project context files (AGENTS.md, README.md, gotchas.md, .claude/rules/) for consistency, accuracy, and structural alignment.                                                                                                                                                                                                                                  |
