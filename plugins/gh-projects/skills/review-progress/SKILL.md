...
- Ready — open かつ blocked-by が全て完了相当（Need Review 以降 / closed）
  - 意味: 即着手可能
- Blocked — open かつ blocked-by に未完了（Need Review 未満）がある
  - 意味: 解除待ち
- In Progress — Project Status = In Progress
  - 意味: 進行中
- Need Review — Project Status = Need Review
  - 意味: 作業・確認は完了、人間の close 待ち
- Stale — In Progress のまま更新が長期間ない
  - 意味: 滞留疑い
- Done — closed
  - 意味: 完了（close は人間が行う）
