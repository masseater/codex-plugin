...
- 0 — プロジェクト方針
  - 主要コマンド: steering スキル
- 1 — タスク初期化・設計・定義
  - 主要コマンド: `/sdd:spec init`, `/sdd:spec requirements`, `/sdd:spec technical`
- 2 — 調査・明確化
  - 主要コマンド: `/sdd:research conduct`, `/sdd:research clarify`
- 3 — Phase構成決定
  - 主要コマンド: `/sdd:phase plan`
- 4 — Phaseサイクル
  - 主要コマンド: `/sdd:phase breakdown`, `/sdd:phase implement`, `/sdd:validate`
